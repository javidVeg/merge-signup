...
import videoGif from "../../Images/videoScrollGif.gif"
...
const VideoScroll = () => {
  ...
  useEffect(() => {
    ...
    mm.add('(min-width: 767px)', () => {
      //! MAKES THE GIF FOR MOBILE DEVICES HIDDEN
      gsap.set(".videoGif", { display: "none" })
      gsap.set(".p-gif", { display: "none" })
  ...
  useEffect(() => {
    mm.add('(min-width: 767px)', () => {
      //! CHANGES THE POSITION FOR MOBILE DEVICES
      gsap.set(".tabs", { display: "flex" })
      gsap.set(".philosophie", { height: "auto" })
    ...
    <>
      <div className="scroll-container">
        ...
        <div className="section-right">
          ...
          <p className="p-gif">(this is the mobile version using a Gif instead of an MP4)</p>
          <img className="videoGif" src={videoGif} alt="video-gif" />
        </div>
      </div>
